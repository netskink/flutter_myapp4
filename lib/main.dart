...
// remember that I have this dart vim plugin
...
1  Putting a Column inside an Expanded widget stretches the column to use all 
   remaining free space in the row. Setting the crossAxisAlignment property 
   to CrossAxisAlignment.start positions the column at the start of the row.
    ...
    Widget titleSection = Container(
      ...
      child: Row(
        children: [
          ...
          /*3*/ // Icon changed to FavoriteWidget()
          FavoriteWidget(),
        ],
      ),
    );
